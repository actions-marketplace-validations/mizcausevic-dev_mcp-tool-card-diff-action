...
export async function run(env) {
    ...
    if (prevRaw !== null) {
        try {
            ...
            write(`::warning::could not parse previous ToolCard at ${baseSha}:${cardPath} — treating as new card. (${e.message})`);
            prev = null;
        }
    }
    ...
    const diff = newCard ? NULL_DIFF : diffToolCards(prev, next);
